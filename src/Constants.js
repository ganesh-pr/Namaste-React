...
export const RESTAURANT_FETCH_ERROR =
  "Unable to display restaurants. Please try after sometime.";

export const RESTAURANT_MENU_API =
  "https://corsproxy.io/?https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&lat=17.385044&lng=78.486671&restaurantId=";
...
export const RESTAURANT_LIST_ERROR_CODE = "1";

export const CORS_ERROR_MESSAGE =
  "This application uses public APIs. If you have not already installed, please install the Chrome extension 'Allow CORS: Access-Control-Allow-Origin'";
